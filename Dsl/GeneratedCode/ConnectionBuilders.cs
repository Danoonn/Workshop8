...
namespace Company.Workshop8
{
	...
	/// </summary>
	public static partial class ConcernReferencesTargetConcernBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::Company.Workshop8.Concern)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::Company.Workshop8.Concern)
				{
					if (candidateTarget is global::Company.Workshop8.Concern)
					{
						global::Company.Workshop8.Concern sourceConcern = (global::Company.Workshop8.Concern)candidateSource;
						global::Company.Workshop8.Concern targetConcern = (global::Company.Workshop8.Concern)candidateTarget;
						if(targetConcern == null || sourceConcern == null || global::Company.Workshop8.ConcernReferencesTargetConcern.GetLinks(sourceConcern, targetConcern).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::Company.Workshop8.Concern)
				{
					if (target is global::Company.Workshop8.Concern)
					{
						global::Company.Workshop8.Concern sourceAccepted = (global::Company.Workshop8.Concern)source;
						global::Company.Workshop8.Concern targetAccepted = (global::Company.Workshop8.Concern)target;
						DslModeling::ElementLink result = new global::Company.Workshop8.ConcernReferencesTargetConcern(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class RelationshipConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new RelationshipConnectAction for the given Diagram.
		/// </summary>
		public RelationshipConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the RelationshipConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new RelationshipConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class RelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the RelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected RelationshipConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder ConcernReferencesTargetConcernBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return ConcernReferencesTargetConcernBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return ConcernReferencesTargetConcernBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				ConcernReferencesTargetConcernBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class RelationshipConnectionType : RelationshipConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the RelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			public RelationshipConnectionType() : base() {}
		}
	}
}
