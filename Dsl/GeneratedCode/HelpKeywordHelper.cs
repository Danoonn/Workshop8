...
namespace Company.Workshop8
{
	...
	/// </remarks>
	public partial class Workshop8HelpKeywordHelper : Workshop8HelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new Workshop8HelpKeywordHelper.
		/// </summary>
		protected Workshop8HelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the Workshop8HelpKeywordHelper.
		/// </summary>
		public static Workshop8HelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class Workshop8HelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new Workshop8HelpKeywordHelperBase.
		/// </summary>
		protected Workshop8HelpKeywordHelperBase()
			: base() { }
