...
namespace Company.Workshop8
{
	...
	/// </summary>
	internal partial class Workshop8DocView : Workshop8DocViewBase
	{
		/// <summary>
		/// Constructs a new Workshop8DocView.
		/// </summary>
		public Workshop8DocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Workshop8DocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new Workshop8DocView.
		/// </summary>
		protected Workshop8DocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			Workshop8DocDataBase docData = this.DocData as Workshop8DocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for Workshop8DocViewBase should be an Workshop8DocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Company.Workshop8.Workshop8Diagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Company.Workshop8.Workshop8Diagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Company.Workshop8.Workshop8ToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Company.Workshop8.Workshop8ToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.Workshop8DiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Company.Workshop8.Workshop8HelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Company.Workshop8.Workshop8HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Company.Workshop8.Workshop8HelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
