...
namespace Company.Workshop8
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.Workshop8EditorFactoryId)]
	internal partial class Workshop8EditorFactory : Workshop8EditorFactoryBase
	{
		/// <summary>
		/// Constructs a new Workshop8EditorFactory.
		/// </summary>
		public Workshop8EditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class Workshop8EditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected Workshop8EditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new Workshop8DocData(this.ServiceProvider, typeof(Workshop8EditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new Workshop8DocView(docData, this.ServiceProvider);
		}
	}
}
